function Load_Inventario() {
    ...
    $.ajax({
        type: 'GET',
        url: 'Api/v1/Inventario.php/lista',
        dataType: 'json',
        headers: {
...
function show_Iventario(id) {
    ...
    $.ajax({
        type: 'GET',
        url: 'Api/v1/Inventario.php/id/' + id,
        dataType: 'json',
        headers: {
            "authtoken": sessionStorage.getItem("token")
        },
...
function update_inventario() {
    ...
    $.ajax({
        type: 'POST',
        url: 'Api/v1/Inventario.php/actualizar/' + id,
        data: insumo,
        dataType: 'json',
        headers: {
            "authtoken": sessionStorage.getItem("token")
...
function delete_inventario(id) {
    ...
    $.ajax({
        type: 'DELETE',
        url: 'Api/v1/Inventario.php/eliminar/' + id,
        dataType: 'json',
        headers: {
            "authtoken": sessionStorage.getItem("token")
        },
...
function insert_inventario() {
    ...
    $.ajax({
        ...
        cache: false,
        data: INFO,
        url: 'Api/v1/Inventario.php/guardarMas',
        headers: {
            "authtoken": sessionStorage.getItem("token")
        },
        success: function (response) {

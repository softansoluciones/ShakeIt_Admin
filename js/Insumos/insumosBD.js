...
function update_insumos() {
  ...
  var insumo = {
    "nombre_Insumo": nom,
    "unidad_Insumo": uni,
    "cantidadmin_Insumo": cant
  };

  $.ajax({
    type: 'POST',
    url: 'Api/v1/Insumos.php/actualizar/' + id,
    data: insumo,
    dataType: 'json',
    headers: {
      "authtoken": sessionStorage.getItem("token")
...
function delete_insumos(id) {
  ...
  $.ajax({
    type: 'DELETE',
    url: 'Api/v1/Insumos.php/eliminar' + id,
    data: insumo,
    dataType: 'json',
    headers: {
      "authtoken": sessionStorage.getItem("token")
...
function insert_insumos() {
  ...
  $.ajax({
    type: 'POST',
    url: 'Api/v1/Insumos.php/guardar',
    data: insumo,
    dataType: 'json',
    headers: {
      "authtoken": sessionStorage.getItem("token")
